//! Vector store implementations: `InMemoryVectorStore`, `VectorStoreRetriever`,
//! `MultiVectorRetriever`, and cosine similarity helper.
//!
//! The [`VectorStore`] and [`Retriever`] traits live in [`crate::types`] and are
...
use crate::{Document, Embeddings, Retriever, SynapticError, VectorStore};

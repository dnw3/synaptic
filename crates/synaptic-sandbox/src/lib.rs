...
//! # Backends
//!
//! - **Docker** (default feature `docker`) — [`docker::DockerSandbox`]
//! - **Apple Container** (feature `apple-container`, macOS only) — [`apple::AppleContainerSandbox`]
//!
//! # Example
//!
//! ```rust,ignore
//! use synaptic_sandbox::{SandboxTool, ResourceLimits};

...
//!
//! Provides [`LanceDbVectorStore`], an implementation of the
...
//! MSRV-compatible versions this module ships a pure-Rust in-memory backend
//! with the full `VectorStore` interface so that your application can compile
//! and test today, and you can swap in the real LanceDB backend when your
//! toolchain supports it.
//!
//! # Example
//!
//! ```rust,no_run
//! use synaptic_rag::vectorstores::lancedb::{LanceDbConfig, LanceDbVectorStore};
//!

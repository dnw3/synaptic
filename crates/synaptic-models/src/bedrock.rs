...
//!
//! This module provides [`BedrockChatModel`], an implementation of the
...
//!
//! ```rust,no_run
//! use synaptic_models::bedrock::{BedrockChatModel, BedrockConfig};
//!
...
pub use synaptic_core::{ChatRequest as BedrockChatRequest, ChatResponse as BedrockChatResponse};
